...
A Chrome extension that renders **Markdown** and **PlantUML** files directly in the browser when viewing them in Azure DevOps (dev.azure.com).
...
1. Browse to any `.md` or `.puml` file in Azure DevOps
